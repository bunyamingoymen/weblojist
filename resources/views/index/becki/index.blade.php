...
@section('index_body')
    ...
    @if ((isset($show_services) && isset($show_services->value) && $show_services->value == '1') || !isset($show_services))
    ...
    @if (
        (isset($show_suppliers) && isset($show_suppliers->value) && $show_suppliers->value == '1') ||
            !isset($show_suppliers))
