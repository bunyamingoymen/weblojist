                ...
                <ul>
                    <li data-index="rs-16" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption  " id="slide-16-layer-15" data-x="['center','center','center','center']"
                            ...
                            data-blendmode="overlay" style="z-index: 5;"><img src="assets/images/blurbg7.jpg" alt=""
                        ...
                        <div class="tp-caption   tp-resizeme  blurslider-gradient" id="slide-16-layer-6"
                            ...
                            data-fontsize="['60','60','40','40']" data-lineheight="['80','80','60','60']" data-width="none"
                        ...
                        <a class="tp-caption rev-btn  tp-resizeme  blurslider-button" href="{{route('index.index')}}"
                            ...
                            data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                            data-voffset="['140','140','110','110']" data-width="none" data-height="none"
                            ...
                            data-paddingleft="[35,35,35,35]" data-blendmode="multiply"
                            style="z-index: 8; white-space: nowrap; font-size: 15px; line-height: 50px; font-weight: 400; color: rgba(255,255,255,1);font-family: 'Roboto', sans-serif;background-color:rgba(4,37,60,1);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;letter-spacing:3px;cursor:pointer;text-decoration: none;">{{ lang_db('BACK TO HOME', 1) }}</a>
                    </li>
                </ul>
...
@section('index_script')
    <link rel="stylesheet"
        href="{{ route('assetFile', ['folder' => 'index/revolution/css', 'filename' => 'revolution.addon.particles.css?ver=1.0.3']) }}">
    <script
        src="{{ route('assetFile', ['folder' => 'index/revolution/js', 'filename' => 'revolution.addon.particles.min.js?ver=1.0.3']) }}">
    </script>
