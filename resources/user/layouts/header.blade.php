@php
    $member_logo = getCachedKeyValue(['key' => 'logos', 'value' => 'Member Logo', 'first' => true]) ?? null;
    $member_logo_small_light =
        getCachedKeyValue(['key' => 'logos', 'value' => 'Member Logo Small Light', 'first' => true]) ?? null;
@endphp
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ isset($member_logo_small_light) ? asset($member_logo_small_light->optional_5) : '' }}"
                            alt="" height="42">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ isset($member_logo) ? asset($member_logo->optional_5) : '' }}" alt=""
                            height="40">
                    </span>
                </a>
            </div>
